<template>
  ...
  >
    ...
    <v-img style="margin:10px 5px" max-width="250" src="@/assets/logo_doviz.png" ></v-img>
    </v-list>
    ...
    >
      ...
      <template v-for="(item, i) in computedItems">
        ...
        <base-item
          v-else-if="item.to == '/exit'"
          :key="`item-${i}`"
          :item="item"
          style="bottom:0 !important;position:absolute !important;width:100% !important;margin:0;padding:19px;background-color:	#eab95e"
        />
        ...
        <!-- <base-item
          v-else-if="item.children.title =='exit'"
          :key="`item-${i}`"
          :item="item"
