		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img style="margin-top:10%; margin-left:15%;" src="@/assets/logo2.png" alt="IMG">
				</div>
          ...
          <div class="row">
             <span v-if="username_pass_error" id="loginfail" class="fa fa-danger" >{{_T('login_fail')}}</span>
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="email" v-model="username"  :placeholder="_T('email')" v-on:keypress.enter="send_data">
  ...
  export default {
    ...
    methods: {
      ...
      async send_data()
      {
        ...
        await this.axios.post(this.API_URL+'/customer/login',form_data).then((response) => {
