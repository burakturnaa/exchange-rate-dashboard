          ...
          <div class="row">
            ...
            <div class="form-group" :class="{ 'form-group--error': $v.sms_code.$error}">
					...
					<div class="container-login100-form-btn">
					 <v-btn @click="send_data" elevation="2" :loading="loading_button"  class=" btn btn-block mybtn  text-white  turbg tx-tfm" style="background-color: #050a23; border-radius:30px" > Doğrula </v-btn>
  ...
  export default {
    ...
    methods: {
      ...
      async send_data()
      {
        ...
        await this.axios.post(this.API_URL+'/userapp/login',form_data).then((response) => {
